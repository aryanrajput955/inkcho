...
export default function BrandShowcase({ startAnimation = true }) {
  ...
  return (
    <div className="w-full">
      {/* --- DESKTOP HERO (GSAP PARALLAX) --- */}
      <div ref={containerRef} className="hidden lg:block relative min-h-screen bg-[#FFFBF5] overflow-hidden">
        ...
        {images.map((image, index) => (
          <div
            ...
            className={`absolute ${image.position} opacity-0 z-0 will-change-transform`} 
          >
          ...
          <div className="text-center max-w-2xl">
            <div ref={titleRef} className="flex justify-center mb-10 opacity-0">
              <OptimizedImage
                ...
                height={400}
                priority
                className="w-full max-w-lg md:max-w-2xl h-auto object-contain"
              />
            </div>
