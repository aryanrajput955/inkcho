    ...
    <div className="bg-[#f7f4ec] min-h-screen pt-40 md:pt-56 pb-32 px-6 sm:px-10 font-[var(--font-body)] text-[#1e1e1e]">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.header 
          ...
          className="mb-16"
        >
          <h1 className="text-4xl md:text-6xl font-serif font-bold text-[#9a1b40] mb-4">TERMS AND CONDITIONS</h1>
          <p className="text-black/50 font-bold uppercase tracking-widest text-sm">Last updated: 10 March 2026</p>
        </motion.header>
        ...
        >
          <section className="space-y-6">
            <h2 className="text-2xl font-serif font-bold text-[#1e4389]">AGREEMENT TO OUR LEGAL TERMS</h2>
            <p>We are Inkcho Designs Ltd (<strong>"Company,"</strong> <strong>"we,"</strong> <strong>"us,"</strong> <strong>"our"</strong>).</p>
            <p>We operate <a href="https://www.inkchodesigns.com/" className="text-[#1e4389] underline">https://www.inkchodesigns.com/</a> , as well as any other related products and services that refer or link to these legal terms (the <strong>"Legal Terms"</strong>) (collectively, the <strong>"Services"</strong>).</p>
            <p>You can contact us by email at <a href="mailto:hello@inkchodesigns.com" className="text-[#9a1b40] font-bold">hello@inkchodesigns.com</a> or by mail to Inkcho Designs Ltd, England, United Kingdom.</p>
            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether 
              personally or on behalf of an entity (<strong>"you"</strong>), and Inkcho Designs Ltd, concerning your 
          ...
          <section className="space-y-12 pt-16">
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">1. OUR SERVICES</h2>
              <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">2. INTELLECTUAL PROPERTY RIGHTS</h2>
              <div className="space-y-4">
                <p className="font-bold underline text-[#9a1b40]">Our intellectual property</p>
                ...
                <p>The Content and Marks are provided in or through the Services <strong>"AS IS"</strong> for your personal, non-commercial use or internal business purpose only.</p>
              </div>
              <div className="space-y-4 pt-4">
                <p className="font-bold underline text-[#9a1b40]">Your use of our Services</p>
                ...
                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:hello@inkchodesigns.com" className="font-bold">hello@inkchodesigns.com</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
                <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>
              </div>
              <div className="space-y-4 pt-4">
                <p className="font-bold underline text-[#9a1b40]">Your submissions</p>
                ...
                <p><strong>Submissions:</strong> By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services (<strong>"Submissions"</strong>), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">3. USER REPRESENTATIONS</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">4. PROHIBITED ACTIVITIES</h2>
              <p>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
              <p>As a user of the Services, you agree not to:</p>
              <ul className="list-disc pl-10 space-y-3 marker:text-[#9a1b40]">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">5. USER GENERATED CONTRIBUTIONS</h2>
              <p>The Services does not offer users to submit or post content. We may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Services, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, <strong>"Contributions"</strong>). Contributions may be viewable by other users of the Services and through third-party websites. When you create or make available any Contributions, you thereby represent and warrant that:</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">6. CONTRIBUTION LICENSE</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">7. SERVICES MANAGEMENT</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">8. TERM AND TERMINATION</h2>
              <p>These Legal Terms shall remain in full force and effect while you use the Services.</p>
              <p><strong>WITHOUT LIMITING ANY OTHER PROVISION OF THESE LEGAL TERMS, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SERVICES (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE LEGAL TERMS OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</strong></p>
              <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">9. MODIFICATIONS AND INTERRUPTIONS</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">10. GOVERNING LAW</h2>
              <p>These Legal Terms shall be governed by and defined following the laws of England and Wales. Inkcho Designs Ltd and yourself irrevocably consent that the courts of England and Wales shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">11. DISPUTE RESOLUTION</h2>
              <p className="font-bold underline text-[#9a1b40]">Informal Negotiations</p>
              ...
              <p className="font-bold underline text-[#9a1b40] pt-4">Binding Arbitration</p>
              <p>Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be 1. The seat, or legal place, or arbitration shall be London, United Kingdom. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of England and Wales.</p>
              
              <p className="font-bold underline text-[#9a1b40] pt-4">Restrictions</p>
              <p>The Parties agree that any arbitration shall be limited to the Dispute between the Parties individually. To the full extent permitted by law, (a) no arbitration shall be joined with any other proceeding; (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilize class action procedures; and (c) there is no right or authority for any Dispute to be brought in a purported representative capacity on behalf of the general public or any other persons.</p>
              
              <p className="font-bold underline text-[#9a1b40] pt-4">Exceptions to Informal Negotiations and Arbitration</p>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">12. CORRECTIONS</h2>
              <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">13. DISCLAIMER</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">16. USER DATA</h2>
              <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-[#1e4389]">18. MISCELLANEOUS</h2>
